...
function getFallbackNostalgia(date: string) {
  ...
  const year = parts[0] ? parseInt(parts[0]) : 1995;
  ...
  if (year < 1970) {
    ...
    return {
      ...
      billboardRank: "#1 Billboard Modern Rock",
